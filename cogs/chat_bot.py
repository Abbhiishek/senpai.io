...
API_URL = 'https://api-inference.huggingface.co/models/ABBHISHEK/'
...
class chat_bot(commands.Cog):
    def __init__(self , model_name):
        ...
        HUGGING_FACE_TOKEN = 'api_EfjBXTDoYyGbGDnCPRndZfgxyUMueTDGHt'
        # format the header in our request to Hugging Face
        self.request_headers = {
            'Authorization': 'Bearer {}'.format(HUGGING_FACE_TOKEN)
        }
...
def setup(commands):
    ...
    commands.add_cog(chat_bot('DialoGPT-small-harrypotter'))# DialoGPT-medium-joshua is my model name
    
    print(">>> harryputter load ho gaya !!!!!!!!!")